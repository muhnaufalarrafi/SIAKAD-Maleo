...
export const FilterPanel = React.memo<FilterPanelProps>(({
  ...
  return (
    <div className="p-4 bg-white rounded-xl shadow space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end text-[#18355E]">
        <div>
          <label htmlFor="kelasFilter" className="block text-[#18355E] font-medium mb-1">Filter Kelas</label>
          <Select
            id="kelasFilter"
        ...
        <div>
          <label htmlFor="startDate" className="block font-medium text-[#18355E] mb-1">Dari Tanggal</label>
          <input
            type="date"
            id="startDate"
            value={startDate}
            onChange={(e) => setStartDate(e.target.value)}
            className="w-full px-3 py-2 border text-[#18355E] border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
          />
        </div>
        <div>
          <label htmlFor="endDate" className="block font-medium text-[#18355E] mb-1">Sampai Tanggal</label>
          <input
            type="date"
            id="endDate"
            value={endDate}
